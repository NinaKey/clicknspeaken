...
function nextAnimalTry(){
  ...
  if (task) task.innerHTML = `Pokušaj: <b>${aTry}/${A_MAX}</b> • Slušaj i klikni na: <b>${aAnswer.toUpperCase()}</b>`;
  sayAnimal();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var QUIZZES = {
    animals: {
      ...
      items: [
        { q: "Koja je ovo životinja?", image: "images/cat.png",    type: "text",  answers: ["cat","dog","rabbit","horse"],  correct: 0 },
        { q: "Koja je ovo životinja?", image: "images/dog.png",    type: "text",  answers: ["lion","monkey","dog","fish"],  correct: 2 },
        { q: "Koja je ovo životinja?", image: "images/rabbit.png", type: "text",  answers: ["rabbit","tiger","bear","horse"], correct: 0 },
        { q: "Koja je ovo životinja?", image: "images/fish.png",   type: "text",  answers: ["cat","fish","bird","monkey"],  correct: 1 },
        { q: "Koja je ovo životinja?", image: "images/lion.png",   type: "text",  answers: ["lion","tiger","bear","dog"],    correct: 0 }
      ]
    },
    letters: { // audio red iznad opcija
      title: "🔤 Test — Slova",
      items: [
        { q: "Koje je ovo slovo?", image: "images/letter-a.png", type: "audioLetters", answers: ["A","B","C","D"], correct: 0 },
        { q: "Koje je ovo slovo?", image: "images/letter-m.png", type: "audioLetters", answers: ["N","M","W","H"], correct: 1 },
        { q: "Koje je ovo slovo?", image: "images/letter-e.png", type: "audioLetters", answers: ["F","E","A","B"], correct: 1 },
        { q: "Koje je ovo slovo?", image: "images/letter-s.png", type: "audioLetters", answers: ["S","Z","X","Q"], correct: 0 },
        { q: "Koje je ovo slovo?", image: "images/letter-t.png", type: "audioLetters", answers: ["L","J","T","I"], correct: 2 }
      ]
    },
    numbers: {
      title: "🔢 Test — Brojevi",
      items: [
        { q: "Koji je broj?", image: "images/number3.png",  type: "text", answers: ["two","three","five","eight"], correct: 1 },
        { q: "Koji je broj?", image: "images/number7.png",  type: "text", answers: ["nine","seven","one","six"],   correct: 1 },
        { q: "Koji je broj?", image: "images/number10.png", type: "text", answers: ["ten","five","three","two"],   correct: 0 },
        { q: "Koji je broj?", image: "images/number4.png",  type: "text", answers: ["eight","six","four","one"],   correct: 2 },
        { q: "Koji je broj?", image: "images/number1.png",  type: "text", answers: ["three","two","one","ten"],    correct: 2 }
      ]
    },
    colors: {
      title: "🎨 Test — Boje",
